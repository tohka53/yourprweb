...
export const en: Textos = {
  ...
  meta: {
    inicio: {
      ...
      desc: "Today's programming, your box leaderboard and every one of your PRs in one place. No spreadsheets, no wiped whiteboards.",
    },
    privacidad: {
  ...
  hero: {
    ...
    sub: "Today's programming, your box leaderboard and every one of your personal records in one place. No spreadsheets, no wiped whiteboards.",
    ctaPrincipal: 'I want yourpr in my box',
    ...
    tabs: [
      {
        ...
        items: [
          ...
          { t: 'Log your score and see where you land', d: "The day's leaderboard updates instantly, within your gym and your category." },
      ...
      },
      {
        ...
        items: [
          ...
          { t: 'Your box community', d: 'Profiles, marks and rankings for your people, visible only inside the gym.' },
        ],
      },
      {
        id: 'competencia',
  ...
  descarga: {
    ...
    nota: 'Run a box and want yourpr from day one? Write to us and we will set you up in the first batch of gyms.',
  ...
  contacto: {
    ...
    mensaje: 'Message',
    mensajePh: 'How many members your box has, what you need to solve…',
    enviar: 'Send message',
    enviando: 'Sending…',
