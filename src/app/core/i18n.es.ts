...
export const es = {
  ...
  meta: {
    inicio: {
      ...
      desc: 'La programación del día, el ranking de tu box y todos tus PRs en un solo lugar. Sin hojas de cálculo ni pizarras borradas.',
    },
    privacidad: {
  ...
  hero: {
    ...
    titulo2: 'Rompe tu PR.',
    sub: 'La programación del día, el ranking de tu box y todos tus records personales en un solo lugar. Sin hojas de cálculo ni pizarras borradas.',
    ctaPrincipal: 'Quiero yourpr en mi box',
    ...
    tabs: [
      {
        ...
        items: [
          ...
          { t: 'Sube tu score y mira dónde quedaste', d: 'El ranking del día se actualiza al instante, con tu gimnasio y en tu categoría.' },
      ...
      },
      {
        ...
        items: [
          ...
          { t: 'La comunidad de tu box', d: 'Perfiles, marcas y rankings de tu gente, visibles solo dentro del gimnasio.' },
        ],
      },
      {
        id: 'competencia',
  ...
  descarga: {
    ...
    nota: '¿Tienes un box y quieres usar yourpr desde el día uno? Escríbenos y te damos de alta para la primera camada de gimnasios.',
    notaCta: 'Escríbenos',
  },
